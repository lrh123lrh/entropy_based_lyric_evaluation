...
################ lyric_watanabe ####################                          @@@@@@@@@@@@^^^^^^^^^^^^^^^
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>#
print('------------------acc_avg START: lyric_watanabe')

########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_watanabe/acc_avg/'#same sample size
...
################ lyric_cm ####################
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>#
print('------------------acc_avg START: lyric_cm')

########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_cm/acc_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
...
################ lyric_wikipedia ####################
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>#
print('------------------acc_avg START: lyric_wikipedia')

########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_wikipedia/acc_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
...
################ lyric_wikipedia ####################
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>#
print('------------------acc_avg START: lyric_aozora')

########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_aozora/acc_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_lyric/acc_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
