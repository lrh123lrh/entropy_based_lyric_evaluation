...
dst = '/home/liruihan/Desktop/result/test/lyric_watanabe/acc_01/'#same sample size
...
while(ii < sample_times):
    ...
    notset_folds, test_folds, train_folds, val_folds = CreateValTrainsTests(use_lyric_dataset, wa_dataset, rs_val, rs_test)
    result_rec = []
    for kernel in kernels:
        ...
        #clf = svm.SVC(kernel=kernel, C=c)
        test_accuracy = SVM_TrainAndPredict(notset_folds[0], test_folds[0], kernel, c, kernel_dst + str(ii + 1) + '_')
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_1foldval/lyric_cm/acc_01/'
figure_title = 'cm'
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_1foldval/lyric_wikipedia/acc_01/'
figure_title = 'wiki'
...
################ lyric_aozora ####################
#>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>#
print('------------------acc01 START: lyric_aozora')

########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_1foldval/lyric_aozora/acc_01/'
figure_title = 'aozora'
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_1foldval/lyric_lyric/acc_01/'
figure_title = 'lyric'
