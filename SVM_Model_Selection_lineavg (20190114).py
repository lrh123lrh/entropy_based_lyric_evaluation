...
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_watanabe/line_avg/'#same sample size
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_cm/line_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_wikipedia/line_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_aozora/line_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
...
########### CHANGE #######################
#vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv#
dst = '/home/liruihan/Desktop/result/SVM_Model_Selection/lyric_lyric/line_avg/'
f = codecs.open(dst+'c_value.txt','w')
for value in c_range:
    f.write(str(round(value,1))+'\n')
f.close()
